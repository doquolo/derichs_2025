...
#define ALT_C14_Pin GPIO_PIN_14
#define ALT_C14_GPIO_Port GPIOC
#define ALT_C15_Pin GPIO_PIN_15
#define ALT_C15_GPIO_Port GPIOC
#define LS_A0_Pin GPIO_PIN_0
#define LS_A0_GPIO_Port GPIOA
#define RS_A1_Pin GPIO_PIN_1
#define RS_A1_GPIO_Port GPIOA
#define LS_A2_Pin GPIO_PIN_2
#define LS_A2_GPIO_Port GPIOA
...
#define RS_B13_Pin GPIO_PIN_13
#define RS_B13_GPIO_Port GPIOB
#define JOY_BTN_Pin GPIO_PIN_14
#define JOY_BTN_GPIO_Port GPIOB
#define ENC_BTN_Pin GPIO_PIN_15
#define ENC_BTN_GPIO_Port GPIOB
#define LD_A8_Pin GPIO_PIN_8
#define LD_A8_GPIO_Port GPIOA
#define LD_A11_Pin GPIO_PIN_11
#define LD_A11_GPIO_Port GPIOA
